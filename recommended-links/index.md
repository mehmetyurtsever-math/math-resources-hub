---
layout: default
title: Recommended Math Links
---

# 🔗 Recommended Math Links

A curated list of high-quality external math resources, textbooks, lecture notes, and problem archives.
...
- [MIT OpenCourseWare — Mathematics](https://ocw.mit.edu/courses/mathematics/) — Full courses with notes, problem sets, and exams
- [Open Textbook Library](https://open.umn.edu/opentextbooks/subjects/mathematics) — Peer-reviewed free textbooks

### Analysis
- [Rudin — Principles of Mathematical Analysis (PMA)](https://archive.org/details/Rudin-Principles-Of-Mathematical-Analysis) — "Baby Rudin"; classic real analysis text
- [Tao — Analysis I & II](https://terrytao.wordpress.com/books/) — Rigorous and readable; free blog supplements
- [Bass — Real Analysis for Graduate Students](https://bass.math.uconn.edu/real.html) — Free graduate-level notes

### Algebra
- [Aluffi — Algebra: Chapter 0 (supplementary notes)](https://www.math.fsu.edu/~aluffi/) — Category-theoretic approach to algebra
- [FOAG — Vakil's Algebraic Geometry Notes](https://math.stanford.edu/~vakil/216blog/FOAGnov1817public.pdf) — Foundations of Algebraic Geometry
...
- [Encyclopedia of Mathematics](https://encyclopediaofmath.org/) — Peer-reviewed mathematical encyclopedia
...
- [3Blue1Brown](https://www.youtube.com/@3blue1brown) — Visually intuitive mathematical explanations
- [Richard Borcherds](https://www.youtube.com/@RichardBorcherds) — Graduate-level algebra, geometry, and number theory
